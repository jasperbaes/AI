...
celcius_testset = [-50, 0, 50]

print("Calcuating for dataset... ({} predictions by {} inputs)".format(len(celcius_testset), len(celcius_q)))
...
for cel in celcius_testset:
    print("{}, {}".format(cel, model.predict([cel])[0][0]))
